...
public interface JsonProvider {
   ...
   */
  <T> T parse(String text, TypeReference valueTypeRef);
  ...
  /**
   * Recursively get field's string value from bean.
   */
  String getFieldAsText(Object bean, String field) throws Exception;
}
